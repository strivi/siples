            ...
            <div class="top_nav">
                <?php if(is_login()): ?><ul class="nav" style="margin-right:0">
                        ...
                        <li class="dropdown admin_nav">
                            ...
                            <ul class="dropdown-menu" style="display:none">
                            	<li><a href="<?php echo U('Inn/index/index');?>">前台首页</a></li>
      ...
      <div class="table-bar">
        <div class="fl">
          <?php if(empty($model["extend"])): ?><div class="tools">						
				<a class="btn" href="<?php echo U('tongbugonghao'); ?>">同步客服工号</a>
				<!--<button class="btn ajax-post" target-form="ids" url="<?php echo U('plqtguanli?type=1&model='.$model['id']); ?>">批量启用</button>
				<button class="btn ajax-post" target-form="ids" url="<?php echo U('plqtguanli?type=0&model='.$model['id']); ?>">批量停用</button>	-->
...
<footer class="footer">
      <div class="container">
          <p>
            ...
            -->  
            本系统由<a href="http://design.xpaba.com" target="_blank"> 無有形 </a>强力驱动
            </p>
      </div>
</footer>
