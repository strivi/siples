...
<!--    <label class="radio">
    ...
    <div class="check-item">
	 ...
	 <div class="check-item">
      <input type="radio" name="config[type]" value="4" class="regular-radio" id="config[type]_4" onClick="changeOption()">
      <label for="config[type]_4"></label>多图文
      </div>
	</div> 
...
<div class="form-item cf show show4">
  <label class="item-label"> 多图文ID </label>
  <div class="controls">
    <input type="text" name="config[mult_id]" class="text input-large" value="<?php echo ($data["config"]["mult_id"]["value"]); ?>">
  </div>
</div>
