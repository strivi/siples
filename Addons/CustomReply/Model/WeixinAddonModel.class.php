...
class WeixinAddonModel extends WeixinModel {
	...
	public function subscribe() {
		$data = $this->getData ();
		$QrCode = getQrCodeByEventKey(substr($data['EventKey'],8));
		$keywordArr['aim_id'] = $QrCode['extra_int'];
		$keywordArr['extra_text'] = $QrCode['extra_text'];
		$this->reply($data,$keywordArr);
		return true;
	}
	...
	public function scan() {
		$data = $this->getData ();
		$QrCode = getQrCodeByEventKey($data['EventKey']);
		$keywordArr['aim_id'] = $QrCode['extra_int'];
		$keywordArr['extra_text'] = $QrCode['extra_text'];
		$this->reply($data,$keywordArr);
		return true;
